package com.wolfeiii.epcore.inventory.menu;

import com.wolfeiii.epcore.EPCore;
import com.wolfeiii.epcore.inventory.utilities.AnimationType;
...
public class SimpleMenu implements InventoryHolder {
    ...
    public void open() {
        Bukkit.getScheduler().runTask(EPCore.getPlugin(), () -> player.openInventory(getInventory()));
    }
