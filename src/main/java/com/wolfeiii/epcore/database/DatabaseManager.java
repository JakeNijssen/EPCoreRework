package com.wolfeiii.epcore.database;

import com.wolfeiii.epcore.utilities.logging.LogLevel;
import lombok.Getter;
import com.wolfeiii.epcore.EPCore;
import com.wolfeiii.epcore.database.service.HikariSQLService;
import com.wolfeiii.epcore.database.service.SQLService;
...
public class DatabaseManager {
    ...
    public boolean update(@NotNull String table, @NotNull Map<String, Object> data, @NotNull Map<String, Object> whereData) {
        try {
            ...
            for (Map.Entry<String, Object> whereEntry : whereData.entrySet()) {
                ...
                indexed.put(currentIndex, whereEntry.getValue());
    ...
    public boolean remove(String table, Map<String, Object> whereData) {
        HashMap<Integer, Object> indexed = new HashMap<>();
        try {
            StringBuilder query = new StringBuilder("DELETE FROM ep_" + table + " WHERE ");
            final int[] a = {1};
